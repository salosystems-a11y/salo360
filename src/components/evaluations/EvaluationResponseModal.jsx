    ...
    const EvaluationResponseModal = ({ isOpen, onClose, evaluation, onRespond, getUserName }) => {
      ...
      const handleSubmit = (e) => {
        ...
        onRespond(evaluation.id, scores, comments);
        onClose();
      };
      
      const evaluatedName = getUserName(evaluation.evaluated_id);
